    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Stack(
            children: [
              /// HALL IMAGE - Main background (navigates to details)
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                ...
                child: ClipRRect(
                  ...
                  child: Stack(
                    children: [
                      /// Image with error/loading handling
                      Image.network(
              ...
              /// ❤️ WISHLIST BUTTON - Top left (SEPARATE from card tap)
              Positioned(
                top: 10,
                left: 10,
          ...
          /// DETAILS SECTION (also tappable for navigation)
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
